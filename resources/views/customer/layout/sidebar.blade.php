<div class="main-sidebar">
    <aside id="sidebar-wrapper">
        ...
        <ul class="sidebar-menu">
            ...
            <li class="{{Request::is('customer/orders') ? 'active' : ''}}"><a class="nav-link" href="{{route('customer_order_view')}}"><i class="fa fa-hand-o-right"></i> <span>Orders</span></a></li>
           ...
           {{--<li class="{{Request::is('customer/booking') ? 'active' : ''}}"><a class="nav-link" href="{{route('customer_booking')}}"><i class="fa fa-hand-o-right"></i> <span>Booking</span></a></li>--}}
