                                                ...
                                                <div class="form-group row bdb1 pt_10 mb_0">
                                                    ...
                                                    <div class="col-md-8">
                                                        <div class="iframe-container1">
                                                            <iframe width="500" height="300" src="https://www.youtube.com/embed/{{ $row->video_id }}" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
